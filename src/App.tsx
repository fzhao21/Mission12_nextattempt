...
class Title extends React.Component{
  render(){
    return (<h1> A website that lists information about all the colleges in NCAA Basketball. </h1>);
  }
}
...
class Card extends React.Component < {school: string, name: string, city: string, state: string}> {
  render() {
    const oneBasketball = this.props;
...
function CardList (){
  return (
  <div>
  {Basketball.teams.map(oneBasketball=> <Card {...oneBasketball}/>)}
  </div>
  );
}
